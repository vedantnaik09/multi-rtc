...
export async function POST(req: Request) {
  ...
  const messages = [
    new SystemMessage(
      `
      Examine the provided interview transcript between an interviewer and a candidate. Your task is to identify any questions, scenarios, or coding challenges posed by the interviewer. Once identified, you should generate the following response for an interviewee with ${YOE} years of experience:
